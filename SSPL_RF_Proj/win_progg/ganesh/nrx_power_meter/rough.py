...
class ConnectScreen(QWidget):
    def __init__(self, switch_callback):
        ...
        self.status_label = QLabel("Click 'Connect' to search for NRP2.")
        ...
        try:
            ...
            for res in resources:
                try:
                    ...
                    idn = inst.query("*IDN?")
                    if "NRP" in idn or "Rohde & Schwarz" in idn:
                        self.instrument = inst
                        self.status_label.setText(f"Found: {idn.strip()}")
                    ...
                    continue
            self.status_label.setText("No NRP2 instruments found.")
...
class ControlScreen(QWidget):
    def __init__(self, instrument):
        ...
        self.reading_label = QLabel("Live Power: -- dBm")
    ...
    def read_power(self):
        try:
            ...
            self.reading_label.setText(f"Error: {e}")


class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Power Meter Reader")
